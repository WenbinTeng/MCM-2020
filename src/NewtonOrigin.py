# Optimization Method: Origin Newton Method
...
def Newton_Ori(f_sym,x_sym,x_ini):
    ...
    while gen < gen_max:
        ...
        x_cur = x_cur - np.dot(g_val,np.linalg.inv(h_val)) * 0.200005
...
if __name__ == "__main__":
    ...
    x_sym = [x1,x2]
    x_ini = [0.5,0.2]
    f_val,x_cur,x_rec = Newton_Ori(f,x_sym,x_ini)
